...
async function seedFeedbacks() {
  const raw = fs.readFileSync(path.join('apps', 'web', 'feedbacks.json'), 'utf8');
...
async function seedOnboardings() {
  const raw = fs.readFileSync(path.join('apps', 'web', 'onboardings.json'), 'utf8');
...
async function seedEvents() {
  const raw = fs.readFileSync(path.join('apps', 'web', 'events.json'), 'utf8');
