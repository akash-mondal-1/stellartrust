...
// Contract IDs
export const IDENTITY_CONTRACT = process.env.NEXT_PUBLIC_IDENTITY_CONTRACT || 'CBAJHSDO3F6LIQPB7OTT4HPYJIE3EPH2ZKTSVBS3QB7IQ7CONI644REP';
export const ESCROW_CONTRACT = process.env.NEXT_PUBLIC_ESCROW_CONTRACT || 'CC5IPJJYJTHSANTIX2RR6BZZ4OY7RDCZLPLMZIVEMIBTYAUYGVCSHIJJ';
export const REPUTATION_CONTRACT = process.env.NEXT_PUBLIC_REPUTATION_CONTRACT || 'CBGEGODHEMTZTIOVO7L66RRTAKEMAGYCXEM37BVZFT4ZCUGQYHEOZFD6';
export const NFT_CONTRACT = process.env.NEXT_PUBLIC_NFT_CONTRACT || 'CDOBVROTIXHQWRZBFYTBJICIZ2BITWPFTN5RTXO3J7NUBX3TUPX33FWU';
