...
export default function SubmissionDashboard() {
  ...
  const contractIds = {
    identity: process.env.NEXT_PUBLIC_IDENTITY_CONTRACT || 'CBAJHSDO3F6LIQPB7OTT4HPYJIE3EPH2ZKTSVBS3QB7IQ7CONI644REP',
    escrow: process.env.NEXT_PUBLIC_ESCROW_CONTRACT || 'CC5IPJJYJTHSANTIX2RR6BZZ4OY7RDCZLPLMZIVEMIBTYAUYGVCSHIJJ',
    reputation: process.env.NEXT_PUBLIC_REPUTATION_CONTRACT || 'CBGEGODHEMTZTIOVO7L66RRTAKEMAGYCXEM37BVZFT4ZCUGQYHEOZFD6',
